...
const disabled: CommunicationBridgeSnapshot = { enabled: false, readiness: 'disabled', cleanup: 'confirmed', sessionStatus: { instanceLabel: 'Instance 0123456789abcdef', sessionLabel: null, prompt: 'unknown', client: 'unknown', connected: false }, metadata: [] };
