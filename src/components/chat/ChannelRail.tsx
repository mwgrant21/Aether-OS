...
function railStyle(colors: ColorPalette): CSSProperties {
  return {
    width: 220,
    flex: 'none',
    padding: 15,
...
function pickerStyle(colors: ColorPalette): CSSProperties {
  return {
    marginTop: 10,
    padding: 8,
    borderRadius: 9,
...
function nameStyle(colors: ColorPalette, archived: boolean): CSSProperties {
  return {
...
function removeStyle(colors: ColorPalette): CSSProperties {
  return { flex: 'none', cursor: 'pointer', font: `700 13px/1 ${fonts.ui}`, color: colors.dangerSoft, padding: '2px 5px' };
}
